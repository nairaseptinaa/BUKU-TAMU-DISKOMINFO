...
Route::middleware('auth')->prefix('admin')->name('admin.')->group(function (): void {
    ...
    Route::get('/tamu/{guest}/edit', [AdminController::class, 'editGuest'])->name('guests.edit');
    Route::put('/tamu/{guest}', [AdminController::class, 'updateGuest'])->name('guests.update');
    Route::delete('/tamu/{guest}', [AdminController::class, 'destroyGuest'])->name('guests.destroy');
